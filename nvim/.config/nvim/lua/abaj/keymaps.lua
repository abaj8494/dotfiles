...
vim.keymap.set('n', '<leader>ll', '<cmd>Leet list<CR>', { desc = 'Browse LeetCode problems' })
vim.keymap.set('n', '<leader>lr', '<cmd>Leet random<CR>', { desc = 'Open random problem' })
vim.keymap.set('n', '<leader>ld', '<cmd>Leet daily<CR>', { desc = 'Open daily problem' })
vim.keymap.set('n', '<leader>ls', '<cmd>Leet submit<CR>', { desc = 'Submit solution' })
vim.keymap.set('n', '<leader>lt', '<cmd>Leet test<CR>', { desc = 'Test solution' })
vim.keymap.set('n', '<leader>li', '<cmd>tabnew<CR><cmd>Leet desc<CR>', { desc = 'Open problem description in new tab' })
vim.keymap.set('n', '<leader>lc', '<cmd>Leet console<CR>', { desc = 'Open test console' })
vim.keymap.set('n', '<leader>lk', '<cmd>Leet cookie update<CR>', { desc = 'Update LeetCode cookie' })
